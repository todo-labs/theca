          ...
          <FieldGroup>
            <Field orientation="horizontal">
              <div className="flex flex-col gap-1.5 flex-1">
                <FieldLabel htmlFor="showProgressPublicly">
              ...
              <Checkbox
                ...
                onCheckedChange={(checked) =>
                  form.setValue("showProgressPublicly", !!checked)
                }
              />
            </Field>
            ...
            <Field orientation="horizontal">
              <div className="flex flex-col gap-1.5 flex-1">
                <FieldLabel htmlFor="showGoalsPublicly">
              ...
              <Checkbox
                ...
                onCheckedChange={(checked) =>
                  form.setValue("showGoalsPublicly", !!checked)
                }
              />
            </Field>
            ...
            <Field orientation="horizontal">
              <div className="flex flex-col gap-1.5 flex-1">
                <FieldLabel htmlFor="recommendations_enabled">
              ...
              <Checkbox
                ...
                onCheckedChange={(checked) =>
                  form.setValue("recommendations_enabled", !!checked)
                }
              />
            </Field>
            ...
            <Field orientation="horizontal">
              <div className="flex flex-col gap-1.5 flex-1">
                <FieldLabel htmlFor="showWishlistPublicly">
                  Public Wishlist
                </FieldLabel>
                <FieldDescription>
                  Show your wishlist books to visitors.
                </FieldDescription>
              </div>
              <Checkbox
                id="showWishlistPublicly"
                checked={form.watch("showWishlistPublicly")}
                onCheckedChange={(checked) =>
                  form.setValue("showWishlistPublicly", !!checked)
                }
              />
            </Field>

            <Field>
              <FieldLabel htmlFor="defaultBookVisibility">
